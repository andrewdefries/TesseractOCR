...
######
cat RemainderList | sed -n '/.*[02468]/p' | sed '1!G;h;$!d' > EvenWorkListRev
cat RemainderList | sed -n '/.*[13579]/p' | sed '1!G;h;$!d' > OddWorkListRev
######
...
######
cat RevRemainderList | sed -n '/.*[02468]/p' | sed '1!G;h;$!d' > EvenWorkListRev
cat RevRemainderList | sed -n '/.*[13579]/p' | sed '1!G;h;$!d' > OddWorkListRev
######
######
