...
rm *.crop.jpg
############
gsutil ls gs://pesticides2crunch/PlantSubstances/Batch1 |  sed -n '/.*[02468]\.jpg/p' > Even
gsutil ls gs://pesticides2crunch/PlantSubstances/Batch1 |  sed -n '/.*[13579]\.jpg/p' > Odd
############
even=(`cat Even`)
odd=(`cat Odd`)
############
